...
const DEFAULTS: Record<Locale, Record<string, string>> = {
    EN: {
        ...
        featuresTitle: "Why Choose StepPrs?",
        ...
        ctaSubtitle: "Join 50,000+ others who found instant pain relief with StepPrs.",
    ...
    FR: {
        ...
        featuresTitle: "Pourquoi StepPrs ?",
        ...
        ctaSubtitle: "Rejoignez 50 000+ personnes qui ont trouvé un soulagement instantané avec StepPrs.",
    ...
    ES: {
        ...
        ctaSubtitle: "Únete a 50,000+ personas que encontraron alivio instantáneo con StepPrs.",
    ...
    if (!config) {
        config = await prisma.siteConfig.create({
            data: {
                ...
                homeTitle: "StepPrs – Premium Orthopaedic Insoles",
                texts: DEFAULTS,
            }
        })
    }
