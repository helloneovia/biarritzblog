        ...
        <section className="py-24 bg-muted/20">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    {PROFILES.map((p, i) => (
                        <div key={i} className="bg-white rounded-3xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col">
                            {/* Header */}
                            <div className="p-5 flex items-start gap-3 border-b border-gray-100">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="font-black text-sm truncate text-gray-900">{p.name}</p>
                            ...
                            {/* Actions */}
                            <div className="px-5 py-4 border-t border-gray-100 flex items-center gap-5 text-xs text-gray-500">
                                <button
                                    onClick={() => toggleLike(i)}
                                    className={`flex items-center gap-1.5 font-semibold transition-colors ${liked[i] ? "text-red-500" : "text-gray-500 hover:text-red-400"}`}
                                >
