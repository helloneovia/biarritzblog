...
const DEFAULT_TEXTS: Record<Locale, Record<string, string>> = {
    EN: {
        ...
        featuresTitle: "Why Choose StepPrs?", featuresSubtitle: "Built with advanced podiatric technology.",
    ...
    FR: {
        ...
        heroImage: "https://images.unsplash.com/photo-1608231387042-66d1773070a5?auto=format&fit=crop&w=1000&q=80",
        featuresTitle: "Pourquoi StepPrs ?", featuresSubtitle: "Conçues avec une technologie podiatrique avancée.",
    ...
    ES: {
        ...
        heroImage: "https://images.unsplash.com/photo-1608231387042-66d1773070a5?auto=format&fit=crop&w=1000&q=80",
        featuresTitle: "¿Por qué StepPrs?", featuresSubtitle: "Diseñadas con tecnología podátrica avanzada.",
